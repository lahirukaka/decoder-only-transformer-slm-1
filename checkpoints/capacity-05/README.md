...
This folder contains a checkpoint run using the same width and depth as `capacity-04`, but with the `capacity-05` inference/training convention of `pre_norm=True` and untied token embedding/output projection weights.
...
- Train loss: `3.601667642593384`
- Validation loss: `3.4712566825973084`
- Best validation loss: `3.4712566825973084`

### `latest.pt`

- Saved epoch index: `68` (epoch 69 of 70)
- Train loss: `3.601097583770752`
- Validation loss: `3.472466381422552`
- Best validation loss at that point: `3.4712566825973084`

### `loss.json`

- Logged epochs: `69`
- First entry learning rate: `0.0009996318490886249`
- Final entry learning rate: `3.0516493448856314e-05`
- Final logged global steps: `870696`
...
- This run keeps the `capacity-04` dimensions but switches to the `capacity-05` pre-norm behavior used by `src/transformer_decoder_slm/generate.py`.
